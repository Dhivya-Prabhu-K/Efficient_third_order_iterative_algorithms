...
% This code is to find all zeros of Legendre polynomial using SOM
  ...
  while i< 3
       [xt,x0,y0,y1, k]=fixedzser_second_1(n,xi,y0,y1);
       i=i+1;
       x(i)=xt;
       N(i) = k;
       de=-tanh(pi/(2*(n+1)));
...
function [x,x0,y0,y1, i]=fixedzser_second_1(n,x0,y0,y1)
